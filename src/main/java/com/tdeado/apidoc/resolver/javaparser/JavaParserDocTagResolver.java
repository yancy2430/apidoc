package com.tdeado.apidoc.resolver.javaparser;
...
import com.tdeado.apidoc.resolver.IgnoreApi;
import com.tdeado.apidoc.resolver.javaparser.converter.JavaParserTagConverter;
import com.tdeado.apidoc.resolver.javaparser.converter.JavaParserTagConverterRegistrar;
...
//                            log.warn("查找不到方法:{}.{}", moduleType.getSimpleName(), m.getNameAsString());
                ...
                if (apiModule.getApiActions().size()>0) {

                    apiModules.add(apiModule);
                }

            } catch (Exception e) {
                System.err.println("解析{}失败:{}"+file+ e.getMessage());
                continue;
            }
        }
        return apiModules;
